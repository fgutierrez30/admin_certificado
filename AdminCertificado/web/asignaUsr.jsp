              ...
              <div class="card-body">
                ...
                <div class="card-body">
                 <div class="row">
                  ...
                  <div class="row"> 
                    <div class="col-12">
                        <select class="form-control" name="cmbAutoriza">
                          <option>(Seleccione Jefatura)</option>
                          <c:forEach items="${autoriza}" var="jefe">
                              
                              <option value="${jefe.nomUsrCv} ${jefe.apellUsrCv}"><c:out value="${jefe.nomUsrCv} ${jefe.apellUsrCv}"/> </option>
                  ...
                  <fieldset>
                      ...
                      <input type="hidden" name="idUsr" value="${usuario.rutUsrCv}" />
